...
var Query = function () {
    ...
    Query.prototype.setTarget = function (target_value, target_reference, target_description) {
        ...
        if (!target_value || !(target_value instanceof String)) {
    ...
    Query.prototype.setType = function (type) {
        ...
        if (!type || !(type instanceof String) || QUERY_TYPES.indexOf(type) < 0) {
