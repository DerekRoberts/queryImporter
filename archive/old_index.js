 ...
 * to actually pull the reduce function from the queries repo. However,
 ...
 *                    arguments.
 *
 * @return {String} a string indicating how the program should proceed.
 */
 ...
 * @param {boolean} reclone - a boolean value, defaults to true.
 */
...
function checkIntegrity() {
    if (!fs.existsSync(QUERIES_DIR + "queries") || !fs.existsSync(QUERIES_DIR + "functions")
    ) {
        //if we get to here, then we are missing a directory.
        throw {
            name   : "DirectoryNotFound",
            message: "The queries and functions/ directories were not found in the queries repo."
        };
        return false;
    }
